...
class ModbusClientSerialRtuBase extends ModbusClientSerial {
  ...
  Future<ModbusResponseCode> readResponseHeader(
      ModbusSerialResponse response, Duration timeout) async {
    try {
      // Read header data
      var byteCount = 3;
  ...
  ModbusResponseCode _checksumCheck(ModbusSerialResponse response) {
